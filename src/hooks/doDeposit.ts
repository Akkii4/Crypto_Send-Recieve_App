import WalletProtocol from "../abis/WalletProtocol.json";
...
export async function doDeposit(
  ...
  if (window.ethereum) {
    try {
      ...
      let contract = new window.web3.eth.Contract(WalletProtocol.abi,  SMART_CONTRACT_ADDRESS_MAP[userNetwork.chainId]);
